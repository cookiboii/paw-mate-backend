...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, errorMessage);
    ...
    public ResponseEntity<ApiErrorResponse> handleAccessDeniedException(AccessDeniedException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.UNAUTHORIZED_AUTHOR);
    ...
    public ResponseEntity<ApiErrorResponse> handleAuthenticationException(AuthenticationException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.UNAUTHORIZED);
    ...
    public ResponseEntity<ApiErrorResponse> handleEntityNotFoundException(EntityNotFoundException e) {
        ...
        ApiErrorResponse response = new ApiErrorResponse(HttpStatus.NOT_FOUND, e.getMessage());
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, message);
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, "요청 본문(JSON)의 형식이 올바르지 않습니다.");
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, "업로드 파일 크기 제한(10MB)을 초과했습니다.");
    ...
    public ResponseEntity<ApiErrorResponse> handleBadRequestExceptions(RuntimeException e) {
        ...
        ApiErrorResponse response = new ApiErrorResponse(HttpStatus.BAD_REQUEST, e.getMessage());
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleOptimisticLockException(Exception e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.CONCURRENT_UPDATE_CONFLICT);
    ...
    public ResponseEntity<ApiErrorResponse> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
        ...
        ApiErrorResponse response = ApiErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, "중복된 데이터가 존재하거나 제약조건을 위반했습니다.");
        return new ResponseEntity<>(response, HttpStatus.CONFLICT);
    }
