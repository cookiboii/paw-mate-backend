...
public interface AdoptionControllerDocs {
    ...
    ResponseEntity<CommonResponse<AdoptionResponse>> applyAdoption(
    ...
    ResponseEntity<CommonResponse<java.util.List<AdoptionResponse>>> myAdoption(@AuthenticationPrincipal CustomUserDetails userDetails);
    ...
    ResponseEntity<CommonResponse<java.util.List<AdoptionResponse>>> allAdoptions();
    ...
    ResponseEntity<CommonResponse<org.springframework.data.domain.Page<AdoptionResponse>>> getAdoptionList(Pageable pageable);
    ...
    ResponseEntity<CommonResponse<AdoptionResponse>> updateStatus(
