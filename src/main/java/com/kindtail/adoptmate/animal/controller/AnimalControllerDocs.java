...
public interface AnimalControllerDocs {
    ...
    ResponseEntity<CommonResponse<com.kindtail.adoptmate.animal.dto.AnimalResponse>> createAnimal(@Valid @RequestBody AnimalCreateRequest animalCreateRequest);
    ...
    ResponseEntity<CommonResponse<org.springframework.data.domain.Page<com.kindtail.adoptmate.animal.dto.AnimalResponse>>> getAnimalList(
    ...
    ResponseEntity<CommonResponse<org.springframework.data.domain.Slice<com.kindtail.adoptmate.animal.dto.AnimalResponse>>> getAnimalsByCursor(
    ...
    ResponseEntity<CommonResponse<org.springframework.data.domain.Page<com.kindtail.adoptmate.animal.dto.AnimalResponse>>> getAnimalsBySpecies(
    ...
    ResponseEntity<CommonResponse<com.kindtail.adoptmate.animal.dto.AnimalResponse>> getAnimalById(
    ...
    ResponseEntity<CommonResponse<com.kindtail.adoptmate.animal.dto.AnimalResponse>> updateAnimal(
            @Parameter(description = "동물 ID", example = "1") @PathVariable Long id,
    ...
    ResponseEntity<CommonResponse<Void>> deleteAnimal(
            @Parameter(description = "동물 ID", example = "1") @PathVariable Long id
    );
    ...
    ResponseEntity<CommonResponse<com.kindtail.adoptmate.animal.dto.FavoriteToggleResponse>> toggleFavorite(
            @Parameter(description = "동물 ID", example = "1") @PathVariable Long id,
    ...
    ResponseEntity<CommonResponse<org.springframework.data.domain.Page<com.kindtail.adoptmate.animal.dto.AnimalResponse>>> getMyFavoriteAnimals(
            @Parameter(description = "페이지 번호 (0부터 시작)", example = "0") @RequestParam(defaultValue = "0") @Min(0) int page,
            @Parameter(description = "페이지 크기", example = "10") @RequestParam(defaultValue = "10") @Min(1) @Max(100) int size,
            @AuthenticationPrincipal CustomUserDetails userDetails
    );
    ...
    ResponseEntity<CommonResponse<com.kindtail.adoptmate.animal.dto.FavoriteToggleResponse>> deleteFavorite(
            @Parameter(description = "동물 ID", example = "1") @PathVariable Long id,
            @AuthenticationPrincipal CustomUserDetails userDetails
    );
}
