...
class MemberControllerTest {
    ...
    void refreshToken_성공 () throws Exception {
        ...
        resultActions.andDo(print())
                ...
                .andExpect(jsonPath("$.data.token").value("newAccessToken123"));
    }
    ...
    void getAllMembers_성공 () throws Exception {
        ...
        resultActions.andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.message").value("전체조회"))
    ...
    void changePassword_성공 () throws Exception {
        ...
        given(memberService.changePassword(any(String.class), any(PasswordChangeRequestDto.class)))
